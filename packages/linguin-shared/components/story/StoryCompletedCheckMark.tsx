...
export default function StoryCompletedCheckMark(props: StoryCompletedCheckMark) {
    ...
    return (
        <Div style={{ display: 'flex', flexDirection: 'row', alignItems: 'baseline', gap: '0.5rem', marginLeft: '0.5rem' }}>
            <Tooltip
            ...
            >
                {userStoryStatistics.hasRead
                    ? <Span style={{ fontSize: '0.875rem', fontWeight: '600', display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                        <CheckIcon />
                        Read
                      </Span>
                    : <Span style={{
                          fontSize: Platform.OS == "web" ? '0.75rem' : '0.875rem',
                          fontStyle: 'italic',
                          color: '#cbd5e1',
                          display: 'flex',
                          flexDirection: 'row',
...
function _NoSymbolIcon() {
    return Platform.OS === 'web' ? 
        <NoSymbolIcon style={{ height: '0.75rem', width: '0.75rem', marginRight: '0.25rem' }} /> : 
