...
export function PlayCircleIcon(): JSX.Element {
    return Platform.OS === 'web' ?
        <HeroPlayCircleIcon className="text-sky-300 w-6 h-6" /> :
...
export function PauseCircleIcon(): JSX.Element {
    return Platform.OS === 'web' ?
        <HeroPauseCircleIcon className="text-sky-300 w-6 h-6" /> :
...
export function PlayIcon(): JSX.Element {
    return Platform.OS === 'web' ?
        <HeroPlayIcon className="text-sky-200 w-6 h-6" /> :
...
export function CheckIcon(): JSX.Element {
    return Platform.OS === 'web' ? <HeroCheckIcon className="h-4 w-4 text-green-500 mr-1" /> : <Svg height="20" viewBox="0 -960 960 960" width="16"><Path fill="#22c55e" d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z" /></Svg>
}