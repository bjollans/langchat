...
export function PlayCircleIcon(): JSX.Element {
    return Platform.OS === 'web' ?
        <HeroPlayCircleIcon style={{ color: 'rgb(125, 211, 252)', width: 24, height: 24 }} /> :
...
export function PauseCircleIcon(): JSX.Element {
    return Platform.OS === 'web' ?
        <HeroPauseCircleIcon style={{ color: 'rgb(125, 211, 252)', width: 24, height: 24 }} /> :
...
export function PlayIcon(): JSX.Element {
    return Platform.OS === 'web' ?
        <HeroPlayIcon style={{ color: 'rgb(165, 243, 252)', width: 24, height: 24 }} /> :
...
export function TranslateIcon(): JSX.Element {
    return Platform.OS === 'web' ?
        <LanguageIcon style={{ height: 20, width: 20 }} aria-hidden="true" /> :
...
export function CheckIcon(): JSX.Element {
    return Platform.OS === 'web' ? <HeroCheckIcon style={{ height: 16, width: 16, color: 'rgb(34, 197, 94)', marginRight: 4 }} /> : <Svg height="20" viewBox="0 -960 960 960" width="16"><Path fill="#22c55e" d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z" /></Svg>
}