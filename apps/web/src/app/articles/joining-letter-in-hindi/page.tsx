        ...
        <div className="mx-auto max-w-7xl mt-4 px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl">
                ...
                <ul className="list-disc pl-6 text-lg leading-loose">
                    ...
                    <li><a className="link" href="/articles/hindi-alphabet">Lesson 3: Matras</a></li>
                </ul>
                <p className={pClass}>
                ...
                <ul className={"list-decimal pl-6 text-lg leading-loose"}>
                    <li>
            ...
            <p className={pClass}>
                ...
                {br}
                Be sure to practice reading, else you will forget it. To start, check out our practice texts <a className="link" href="/story/hi">over here</a>.
                {br}
